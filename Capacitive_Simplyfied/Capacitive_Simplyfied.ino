...
//     Serial.print(",");
//     Serial.print("Mode: ");
//     Serial.println(stats.mode(capacitance1,n,0.00001),3);
//     Serial.print(" , ");
...
//  Serial.println(activity);
     ...
     float error1 = 0.68;         //the error of capacitance 1
     float error2 = 0.39;          //the error of capacitance 2
...
//      }
       ...
       if(range(17) && range(18)){        
          myservo.write(20);
          delay(100);
      }
      

      else if(range(19) && range(20)){        
          myservo.write(40);
          delay(100);
      }
...
//      }
       ...
       if(range(25) && range(26)){        
          myservo.write(20);
          delay(100);
      }
      

      else if(range(27) && range(28)){        
          myservo.write(40);
          delay(100);
      }
...
void loop()
{
  timer.run(); // SimpleTimer is working 
     ...
     char range(char a){
      capacitiveRead();
      EEPROM.get(a*5,record[a]);
      return (record[a] >= stats.mode(capacitance1,n,0.00001)-error1) && (record[a] <= stats.mode(capacitance1,n,0.00001)+error1);
     }



        void recordValue(int a,int b){
          capacitiveRead();
          record[a] =stats.mode(capacitance1,n,0.00001);  //Mode
          record[b] = stats.mode(capacitance2,n,0.00001);  //Mode
          EEPROM.put(a*5,record[a]);
          EEPROM.put(b*5,record[b]);
          EEPROM.get(a*5,record[a]);
          Serial.print(record[a]);
        }


//     float capacitiveRead(){
//          
//     float capacitance1[n];
//     float capacitance2[n];
//
