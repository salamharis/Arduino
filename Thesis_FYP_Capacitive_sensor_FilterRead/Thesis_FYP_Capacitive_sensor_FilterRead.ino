...
void loop() {
       ...
       capacitanceRead1 = getMes(NUMSAMPLES,IN_PIN1); // get a measurement of pin 1
       Serial.print(capacitanceRead1); 
       Serial.print(",");
       capacitanceRead2 = getMes(NUMSAMPLES,IN_PIN2); // get a measurementof pin 2
       Serial.print(capacitanceRead2); 
       Serial.print(",");
       capacitanceRead3 = getMes(NUMSAMPLES,IN_PIN3); // get a measurementof pin 3
       Serial.print(capacitanceRead3); 
       Serial.print(",");
       capacitanceRead4 = getMes(NUMSAMPLES,IN_PIN4); // get a measurementof pin 4
       Serial.print(capacitanceRead4); 
       Serial.print(",");
       capacitanceRead5 = getMes(NUMSAMPLES,IN_PIN5); // get a measurementof pin 5
       Serial.print(capacitanceRead5); 
       Serial.print(",");
       capacitanceRead6 = getMes(NUMSAMPLES,IN_PIN6); // get a measurementof pin 6
...
int capacitancevalue(int InputPin){
       ...
       delay(15); //delay in 15 milliseconds for charging the skin 
       
       capacitance = analogRead(InputPin);
         
       digitalWrite(OUT_PIN1, LOW);
       pinMode(InputPin, OUTPUT);
       delay(15); //delay in 15 milliseconds for discharging the skin 
       return capacitance;
  }
...
//will decide whether the current gesture are in range of set range
